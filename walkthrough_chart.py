...
print('')
print(f'total Production tickets in progress: {len(tickets_remaining_df[tickets_remaining_df['Destination']=='Production'])}')
print(f'total XTR tickets in progress: {len(tickets_remaining_df[tickets_remaining_df['Destination']=='XTR'])}')
print(f'total Tube Return and Externals tickets in progress: {len(tickets_remaining_df[tickets_remaining_df['Destination']=='Tube Return & Externals'])}')
print(f'total number Destruction tickets in progress: {len(tickets_remaining_df[tickets_remaining_df['Destination']=='Destruction'])}')
